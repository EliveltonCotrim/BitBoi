                    ...
                    <div class="divide-y divide-gray-200">
                        <div class="py-1 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7 ">
                            ...
                            <section class="hero container max-w-screen-lg mx-auto pb-10">
                                <img class="mx-auto" src="data:image/gif;base64,{{ $result['encodedImage'] }}" alt="Base64 encoded image" style="width: 60%;" />
                            </section>
                            ...
                            <p>
                                ...
                                <input value="<?php echo $result['payload']
                                                ?>" readonly class="js-copytextarea shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="username" type="text">
    ...
    <script>
        $(function() {
            ...
            function loop() {
                $.ajax({
                    type: 'POST',
                    url: "<?php echo url('client/asaas/pix/consult'); ?>",
                    data: {
